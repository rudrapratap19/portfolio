...
export const siteData: SiteData = {
  ...
  projects: [
    {
      ...
      links: [{ label: 'GitHub', href: 'https://github.com/priyanshiiitr/Virtual-Study-Environment-' }],
      tech: ['Flutter', 'Supabase', 'Firebase'],
      summary: 'Productivity app with group/solo study modes, personalized login, and analytics.',
      highlights: [
        'Built a productivity app with Flutter, Supabase, Firebase.',
        'Added group/solo study modes, personalized login, and analytics.'
      ]
    },
    {
  ...
  skills: {
    ...
    backend: ['Firebase (Auth, Firestore, RTDB)', 'Supabase', 'REST APIs'],
